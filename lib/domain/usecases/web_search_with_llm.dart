...
class WebSearchWithLLM {
  ...
  Future<Either<Failure, String>> execute(String userQuery) async {
    try {
      ...
      final queryGenerationResult = await queryGenerator.generateSearchQueries(userQuery);
      
      return queryGenerationResult.fold(
        ...
        (searchQueries) async {
          ...
          for (var query in searchQueries) {
            ...
            try {
              final searchResult = await searchStrategyManager.search(searchQuery);
